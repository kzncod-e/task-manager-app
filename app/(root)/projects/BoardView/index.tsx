          ...
          <div className="flex -space-x-[6px] overflow-hidden">
            {task.assignee && (
              <Image
                ...
                src={`https://pm-s3-bucket1.s3.ap-southeast-2.amazonaws.com/${task.assignee.profilePictureUrl}`}
            ...
            {task.author && (
              <Image
                ...
                src={`https://pm-s3-bucket1.s3.ap-southeast-2.amazonaws.com/${task.author.profilePictureUrl}`}
